      ...
      <div className="container-page relative z-10 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 reveal">
          <div className="eyebrow">
            ...
            The agentic AI marketing partner
          </div>
          ...
          <p className="mt-8 text-lg md:text-xl text-gray-300 max-w-2xl font-light leading-relaxed">
            Six specialist AI agents. One growth system. Built for founders who refuse generic marketing — and need their brand to compound across search, social, and the surfaces buyers actually use in 2026.
          </p>

          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link href="/contact" target="_blank" rel="noopener noreferrer" className="btn-primary text-base">
          ...
          <div className="mt-12 flex items-center gap-6 text-xs text-gray-500 uppercase tracking-[0.18em]">
            <span className="flex items-center gap-2">
              ...
              Trusted by founders across D2C, SaaS, F&B
            </span>
          </div>
        </div>
  ...
  return (
    <div className="glass-strong rounded-2xl p-5 shadow-glow">
      <div className="flex items-center gap-2 pb-4 border-b border-white/5">
        ...
        <span className="ml-3 text-[11px] text-gray-500 font-mono">branstan-core-engine</span>
      </div>

      <div className="mt-5 space-y-2.5 font-mono text-xs">
        <TerminalRow color="violet" label="Cultural Onion mapping..." status="100%" tone="emerald" />
        <TerminalRow color="blue" label="LLM citation surface audit..." status="Active" tone="emerald" />
        <TerminalRow color="cyan" label="Market signal ingestion..." status="847k events" tone="cyan" />
        <TerminalRow color="amber" label="Listening for category shifts..." status="Live" tone="amber" />
        <div className="mt-4 p-3 rounded-lg bg-gradient-to-r from-violet-500/10 to-blue-500/10 border border-violet-500/20 flex items-center justify-between">
          <div>
            <p className="text-[10px] uppercase tracking-wider text-gray-500">Brand visibility target</p>
            <p className="text-white text-sm mt-0.5">Q3 lift: <span className="text-gradient font-semibold">+40% secured</span></p>
          </div>
